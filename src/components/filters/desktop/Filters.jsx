...
const Filters = ({ value, handleChange }) => {
    return (
        <div className='w-[18%] text-xs min-w-[14rem] md:hidden'>
            <div className='flex justify-between items-center mb-3'>
                <h2 className='text-base font-semibold'>FILTERS</h2>
                <div className='text-sm font-semibold text-red-500'>CLEAR ALL</div>
            </div>
            <form action="" className='border px-3'>
                <h2 className='text-sm font-semibold my-3'>Brand</h2>
                <div className='flex flex-col gap-2'>
                    <div className='flex items-center gap-2'>
                        <input type="checkbox" name="" id="" className='w-4 h-4' />
                        <label htmlFor="">KALINI (3359)</label>
                    </div>
                    <div className='flex items-center gap-2'>
                        <input type="checkbox" name="" id="" className='w-4 h-4' />
                        <label htmlFor="">KALINI (3359)</label>
                ...
                <h2 className='text-sm font-semibold my-3'>Price</h2>
                <div>
                ...
                <h2 className='text-sm font-semibold my-3'>Color</h2>
                <div className='flex flex-col gap-2'>
                    <div className='flex items-center gap-2'>
                        <input type="checkbox" name="" id="" className='w-4 h-4' />
